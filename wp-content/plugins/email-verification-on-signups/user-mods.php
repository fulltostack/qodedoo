...
class DWUserVerifyMods extends DWEmailVerify{
	...
	public function __construct(){
		add_action( 'user_new_form', array( $this, 'ignore_field_html')  );
		add_action( 'edit_user_profile', array( $this, 'verification_control_html' ) );
		add_action( 'edit_user_profile_update', array( $this, 'profile_update' ) );
		add_action( 'wp_ajax_dw_resend_verify', array( $this, 'resend_verify_ajaxcb' ) );
		add_action( 'wp_ajax_nopriv_dw_resend_verify', array( $this, 'resend_verify_ajaxcb' ) );
	}
