...
<p>You can use the qodedoo Custom Settings in your WordPress Editor as well using shortcodes , to get the simple value like textarea , text field and html textarea just follow the below shortcode: <br><br>
